/**
 * @overview Cloud function defition for firebase
...
exports.updateTeamsCount = functions
  ...
  .onWrite(async (change, _context) => {
    ...
    changes.forEach((changeReq) => {
      Teams.doc(changeReq.teamId).update({ employeesCount: changeReq.action })
    })
